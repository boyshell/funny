...
public class UpdateValueRequest implements Message {
  ...
  public UpdateValueRequest(com.funny.blood.modules.base.hall.ValueType type, int value) {
    this.type = type;
    this.value = value;
  }

  /** 值类型[1:筹码] */
  private com.funny.blood.modules.base.hall.ValueType type;
  /** 值 */
  private int value;

  /** 值类型[1:筹码] */
  public UpdateValueRequest setType(com.funny.blood.modules.base.hall.ValueType type) {
    this.type = type;
    return this;
  }

  /** 值类型[1:筹码] */
  public com.funny.blood.modules.base.hall.ValueType getType() {
    return this.type;
  }
  ...
  public UpdateValueRequest read(ByteBuf buf) {
    int size52413035;
    this.type = com.funny.blood.modules.base.hall.ValueType.valueOf(ByteBufUtil.readInt(buf));
