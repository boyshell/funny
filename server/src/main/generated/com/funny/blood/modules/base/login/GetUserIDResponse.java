...
public class GetUserIDResponse implements Message {
  ...
  public GetUserIDResponse(String channelID, int userID, com.funny.blood.modules.base.login.GetUserIDError error) {
  ...
  private int userID;
  /** 错误码[1:系统错误][2:顶号] */
  private com.funny.blood.modules.base.login.GetUserIDError error;
  ...
  /** 错误码[1:系统错误][2:顶号] */
  public GetUserIDResponse setError(com.funny.blood.modules.base.login.GetUserIDError error) {
    this.error = error;
    return this;
  }

  /** 错误码[1:系统错误][2:顶号] */
  public com.funny.blood.modules.base.login.GetUserIDError getError() {
    return this.error;
  }
  ...
  public GetUserIDResponse read(ByteBuf buf) {
    ...
    this.error = com.funny.blood.modules.base.login.GetUserIDError.valueOf(ByteBufUtil.readInt(buf));
    return this;
  }
