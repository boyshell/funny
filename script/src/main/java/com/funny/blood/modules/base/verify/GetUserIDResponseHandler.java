...
import com.funny.blood.modules.base.hall.GetHallRequest;
...
import com.funny.blood.net.gate.HallClient;
...
public class GetUserIDResponseHandler implements LoginToGateHandler<GetUserIDResponse> {
  private static final Logger logger = LoggerFactory.getLogger(GetUserIDResponseHandler.class);
